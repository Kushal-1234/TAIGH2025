      ...
      >
        <Container maxWidth="md" className="hero-content">
          ...
          <motion.h2
            ...
            transition={{ duration: 1 }}
          >
            Secure, Uncertainty-aware, Robust and Explainable AI for Health
          </motion.h2>
          <motion.p
          ...
          >
            AAAI Fall Symposium Series 2025 | Arlington, VA
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <Button
              variant="contained"
              color="secondary"
              href='https://easychair.org/account2/signin?l=2056730393552013390'
